    ...
    <div  className={ `w-full z-[10000] ${ active ? "bg-secondary-100 z-50 shadow-xl font-poppins  fixed top-0 left-0  " :
      ...
      <div className="w-11/12 max-w-[1440px]    mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:flex font-poppins items-center text-lg gap-12">
          <Link to="home" activeClass="current" smooth={ true } spy={ true } offset={ -150 } className=" relative cursor-pointer z-10 transition-all bg-[-100%] duration-500 bg-[length:200%_100%] text-transparent bg-gradient bg-clip-text hover:bg-[0%]">Home</Link>
          <Link to="about" activeClass="current"  smooth={ true } spy={ true }  offset={-150}  className="relative cursor-pointer z-10 transition-all bg-[-100%] duration-500 bg-[length:200%_100%] text-transparent bg-gradient bg-clip-text hover:bg-[0%]">About Us</Link>
          <Link to="services"  activeClass="current" smooth={ true } spy={ true }  offset={-150}  className="relative cursor-pointer z-10 transition-all bg-[-100%] duration-500 bg-[length:200%_100%] text-transparent bg-gradient bg-clip-text hover:bg-[0%] ">Services</Link>
          <Link to="portfolio" activeClass="current"  smooth={ true } spy={ true }  offset={-150}  className="relative cursor-pointer z-10 transition-all bg-[-100%] duration-500 bg-[length:200%_100%] text-transparent bg-gradient bg-clip-text hover:bg-[0%]">Our Portfolio</Link>
        ...
        <div className={ `flex relative lg:hidden ${ isOpen ? "" : "" }` }>
          {/* mobile menu */ }
