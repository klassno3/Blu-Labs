        ...
        <motion.div
          ...
          <div className="flex flex-col items-center lg:items-start gap-5">
            ...
            <p className="text-tertiary-100 text-center lg:text-left font-poppins text-sm md:text-lg ">
              ...
              and provide a positive user experience. Our team conducts comprehensive testing and quality
              assurance procedures to guarantee that our software adheres to the highest
              standards in terms of performance, security, and functionality.
            </p>
          </div>
