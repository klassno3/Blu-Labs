    ...
    <div className='portfolio bg-secondary-200 py-16  md:py-20'>
      ...
      <motion.div
        ...
        <motion.div
          ...
          className="flex flex-col items-start shadow-lg   rounded-md bg-white">
          ...
          <div className='flex flex-col p-6 items-start gap-6 '>
            <div className='flex flex-col  items-start gap-1 '>
              ...
              <p className="font-poppins text-tertiary-100/70 text-sm md:text-base ">
                ENKU Gift is an online store where users can explore the selection of products available.
                Upon successful delivery of your order, we will send you an email to confirm its completion.
              </p>
            </div>
            <a
              href='https://enkugifts.pythonanywhere.com'
              target="_blank"
        ...
        <motion.div
          ...
          className="flex flex-col  items-start  rounded-md bg-white shadow-lg">
          ...
          <div className='flex flex-col  items-start gap-1 '>
              ...
              <p className="font-poppins text-tertiary-100/70 text-sm md:text-base ">
                Ismset.com is a web-based school management system that helps
                schools manage student, teacher, parent, and staff registration and academic records.            </p>
            </div>
            <a
              href='https://www.isms.et/'
              target="_blank"
              rel="noopener noreferrer">
              <Button
                small
        ...
        <motion.div
          variants={ leftCardAnimate }
          className="flex flex-col md:flex-row md:col-span-2  md:row-span-1  items-start  rounded-md bg-white shadow-lg">
          ...
          <div className='flex flex-col p-6 items-start gap-6 '>
            <div className='flex flex-col  items-start gap-1 '>
              ...
              <p className="font-poppins text-tertiary-100/70 text-sm md:text-base ">
                Diyethiopia.com is an online electronics shop that offers a variety of electronic, mechanical, and
                electro-mechanical materials and services, such as 3D printing, PCB building, and electro-mechanical designs.      </p>
            </div>
            <a
              href='https://www.diyethiopia.com'
              arget="_blank"
              rel="noopener noreferrer">
              <Button
                small
