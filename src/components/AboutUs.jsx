  ...
  return (
    <div>
      <div className='about max-w-[1440px]   w-11/12 mx-auto '>
        <div className='bg-secondary-100 py-10 md:py-16 lg:pb-16 lg:pt-4'>
          <motion.div
            ...
            <motion.div
              ...
              <div className="flex flex-col items-start gap-3 md:gap-4">
                ...
                <div className={ `${ isOpen ? "flex" : "hidden" } text-tertiary-100 font-poppins text-sm md:text-base ` }>
                  <p>
                    Blu Labs specializes in custom software development, creating tailored solutions to address specific business requirements.
                    We provides consulting and advisory services to assist clients in making informed decisions
                    regarding their software development projects and develops mobile applications for both iOS and Android platforms. These apps are designed to provide intuitive and engaging user experiences.
                  </p>
                </div>
      ...
      <div className=" bg-pattern bg-cover py-10 ">
        <motion.div
          ...
          <motion.div variants={ leftCardAnimate } className="w-full  mx-auto sm:w-3/4 rounded shadow-md bg-secondary-200 px-6 py-8 lg:w-1/3">
            <div className="flex flex-col gap-2 items-center">
              ...
              <p className=" text-tertiary-100/80 text-center  font-poppins text-sm lg:text-base ">
                To be a leading software development company that delivers innovative
                and  customized solutions to meet the evolving needs of businesses and individuals.
              </p>
            </div>
          ...
          <motion.div
            ...
            className="w-full  mx-auto sm:w-3/4 rounded shadow-md bg-secondary-200 px-6 py-8 lg:w-1/3">
            <div className="flex flex-col gap-2 items-center">
              <h3 className="text-lg uppercase md:text-2xl font-inter font-semibold text-primary-300">Mission</h3>
              <p className=" text-tertiary-100/80 text-center  font-poppins text-sm lg:text-base ">
                Blu Labs PLC is dedicated to providing cutting-edge software development services and
          ...
          <motion.div variants={ rightCardAnimate} className="w-full  mx-auto sm:w-3/4 rounded shadow-md bg-secondary-200 px-6 py-8 lg:w-1/3">
            <div className="flex flex-col gap-2 items-center">
              ...
              <p className=" text-tertiary-100/80 text-center  font-poppins text-sm lg:text-base ">
                We embrace creativity and constantly seek innovative solutions to address complex
                business challenges. We are committed to delivering high-quality software development services.
              </p>
            </div>
          </motion.div>
        </motion.div>
